...
namespace EmotionalCities.Lsl
{
    ...
    /// <summary>
    /// Represents a timestamped chunk buffer.
    /// </summary>
    public readonly struct TimestampedChunkBuffer : IEquatable<TimestampedChunkBuffer>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimestampedChunkBuffer"/> structure
        /// with the specified data samples and corresponding timestamps.
        /// </summary>
        /// <param name="data">The data samples of the timestamped chunk buffer.</param>
        /// <param name="timestamps">The timestamps for each data sample, in fractional seconds.</param>
        public TimestampedChunkBuffer(Mat data, Mat timestamps)
        {
            Data = data ?? throw new ArgumentNullException(nameof(data));
            Timestamps = timestamps ?? throw new ArgumentNullException(nameof(timestamps));
            if (data.Cols != timestamps.Cols)
            {
                throw new ArgumentException("The number of timestamps must match the number of samples.", nameof(timestamps));
            }
        }
        ...
        /// Gets the timestamps for each data sample, in fractional seconds.
        /// </summary>
        public Mat Timestamps { get; }

        /// <summary>
        /// Gets the data samples of the timestamped chunk buffer.
        /// </summary>
        public Mat Data { get; }

        /// <summary>
        /// Deconstructs the components of a timestamped chunk buffer into separate variables.
        /// </summary>
        /// <param name="data">The data samples of the timestamped chunk buffer.</param>
        /// <param name="timestamps">The timestamps for each data sample, in fractional seconds.</param>
        public void Deconstruct(out Mat data, out Mat timestamps)
        {
            data = Data;
            timestamps = Timestamps;
        }
        ...
        /// <summary>
        /// Returns a value indicating whether this instance has the same data and timestamps
        /// as a specified <see cref="TimestampedChunkBuffer"/> structure.
        /// </summary>
        /// <param name="other">The <see cref="TimestampedChunkBuffer"/> structure to compare to this instance.</param>
        /// <returns>
        /// <b>true</b> if <paramref name="other"/> has the same data and timestamps as this
        /// instance; otherwise, <b>false</b>.
        /// </returns>
        public bool Equals(TimestampedChunkBuffer other)
        {
            return Timestamps == other.Timestamps && Data == other.Data;
        }

        /// <summary>
        /// Tests to see whether the specified object is a <see cref="TimestampedChunkBuffer"/> structure
        /// with the same data and timestamps as this <see cref="TimestampedChunkBuffer"/> structure.
        /// </summary>
        /// <param name="obj">The <see cref="object"/> to test.</param>
        /// <returns>
        /// <b>true</b> if <paramref name="obj"/> is a <see cref="TimestampedChunkBuffer"/> and has the
        /// same data and timestamps as this <see cref="TimestampedChunkBuffer"/>; otherwise, <b>false</b>.
        /// </returns>
        public override bool Equals(object obj)
        {
            return obj is TimestampedChunkBuffer timestamped && Equals(timestamped);
        }

        /// <summary>
        /// Returns a hash code for this <see cref="TimestampedChunkBuffer"/> structure.
        /// </summary>
        /// <returns>
        /// An integer value that specifies a hash value for this <see cref="TimestampedChunkBuffer"/> structure.
        /// </returns>
        public override int GetHashCode()
        {
            return Timestamps.GetHashCode() ^ Data.GetHashCode();
        ...
        /// <summary>
        /// Creates a <see cref="string"/> representation of this <see cref="TimestampedChunkBuffer"/>
        /// structure.
        /// </summary>
        /// <returns>
        /// A <see cref="string"/> containing the <see cref="Data"/> and <see cref="Timestamps"/>
        /// properties of this <see cref="TimestampedChunkBuffer"/> structure.
        /// </returns>
        public override string ToString()
        {
            return $"{Data}";
        ...
        /// <summary>
        /// Tests whether two <see cref="TimestampedChunkBuffer"/> structures are equal.
        /// </summary>
        /// <param name="left">The <see cref="TimestampedChunkBuffer"/> structure on the left of the equality operator.</param>
        /// <param name="right">The <see cref="TimestampedChunkBuffer"/> structure on the right of the equality operator.</param>
        /// <returns>
        /// <b>true</b> if <paramref name="left"/> and <paramref name="right"/> have the same data and timestamps;
        /// otherwise, <b>false</b>.
        /// </returns>
        public static bool operator ==(TimestampedChunkBuffer left, TimestampedChunkBuffer right)
        {
            return left.Equals(right);
        }

        /// <summary>
        /// Tests whether two <see cref="TimestampedChunkBuffer"/> structures are different.
        /// </summary>
        /// <param name="left">The <see cref="TimestampedChunkBuffer"/> structure on the left of the inequality operator.</param>
        /// <param name="right">The <see cref="TimestampedChunkBuffer"/> structure on the right of the inequality operator.</param>
        /// <returns>
        /// <b>true</b> if <paramref name="left"/> and <paramref name="right"/> differ either in data or timestamps;
        /// <b>false</b> if <paramref name="left"/> and <paramref name="right"/> are equal.
        /// </returns>
    ...
    public static class TimestampedChunk
    {
        ...
        /// </returns>
        public static TimestampedChunk<T> Create<T>(T[,] data, double[] timestamps)
        {
            return new TimestampedChunk<T>(data, timestamps);
        }

        /// <summary>
        /// Creates a new timestamped chunk buffer.
        /// </summary>
        /// <param name="data">The data samples of the timestamped chunk buffer.</param>
        /// <param name="timestamps">The timestamps for each data sample, in fractional seconds.</param>
        /// <returns>
        /// A new instance of the <see cref="TimestampedChunkBuffer"/> class with the specified
        /// array of samples and corresponding timestamps.
        /// </returns>
        public static TimestampedChunkBuffer Create(Mat data, Mat timestamps)
        {
            return new TimestampedChunkBuffer(data, timestamps);
        }
    }
}
