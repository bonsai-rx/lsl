    ...
    */
    public class StreamInlet : LSLObject
    {
        ...
        */
        ...
        // TODO
        public double pull_sample<T>(T[] sample, double timeout = LSL.FOREVER)
        {
            if (sample.GetType() == typeof(float[]))
            {
                return pull_sample(sample as float[], timeout);
            } else
            {
                return pull_sample(sample as int[], timeout);
            }
        }
